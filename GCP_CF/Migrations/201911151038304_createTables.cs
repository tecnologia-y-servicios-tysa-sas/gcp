namespace GCP_CF.Migrations
{
    ...
    public partial class createTables : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.PagoContrato", "Factura_Id", "dbo.Factura", "Factura_Id");
        }
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Factura", "Municipio_Id", "dbo.Personas");
            DropForeignKey("dbo.Factura", "Estado_Id", "dbo.EstadosFactura");
            DropForeignKey("dbo.Factura", "Contrato_Id", "dbo.Contratos");
            DropIndex("dbo.PagoContrato", new[] { "Factura_Id" });
            DropIndex("dbo.PagoContrato", new[] { "Contrato_Id" });
            DropIndex("dbo.Factura", new[] { "Contrato_Id" });
            DropIndex("dbo.Factura", new[] { "Municipio_Id" });
            DropIndex("dbo.Factura", new[] { "Estado_Id" });
            DropTable("dbo.PagoContrato");
